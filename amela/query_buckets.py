...
class Bucket:
    ...
    def solve(self, parent, entity):
        ...
        return parent.bucket(self.get_name(), self.bucket_type, \
                             **self._kwargs)
...
class TimeBucket(Bucket):
    ...
    def __init__(self, entity, interval):
        ...
        if not interval:
            self._kwargs['interval'] = Interval.month.name
        else:
            self._kwargs['interval'] = interval.name

    def get_field_name(self):
        return self.entity.date_field_name
